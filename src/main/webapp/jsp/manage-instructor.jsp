...
<head>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/css/manage-instructor.css">
...
<body>
        ...
        <div class="content">
            <div class="container mt-4">
                ...
                <div class="card p-3 mb-4">
                    ...
                    <form action="<%= request.getContextPath() %>/ManageInstructors" method="post">
                        <div class="row">
                            <div class="col-md-5">
    ...
    <script src="<%= request.getContextPath() %>/js/manage-instructor.js"></script>
